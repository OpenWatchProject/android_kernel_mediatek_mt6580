...
void Auddrv_AWB_Interrupt_Handler(void)
{
	...
	if (MaxCopySize) {
		...
		PRINTK_AUD_AWB("%s update read pointer u4DMAReadIdx:0x%x, u4WriteIdx:0x%x, "
	...
	PRINTK_AUD_AWB("%s Hw_Get_bytes:0x%x, HW_Cur_ReadIdx:0x%x, u4DMAReadIdx:0x%x, u4WriteIdx:0x%x, "
