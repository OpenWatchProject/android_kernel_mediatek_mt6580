...
#define key_1           60,970              //auto define  
#define key_2           240,970
#define key_3           420,970
...
//spyder
#define GET_NUM_TOUCHES(reg)          ((reg) & 0x1F)
...
struct cyttsp5_xydata {
	u8 len_l;
	u8 len_h;
	u8 report_ID;
	u8 timestamp_l;
	u8 timestamp_h;
	u8 rep_stat;   //LO & Number of record
	u8 tt_stat;      //Report Counter  & Noise effects
	struct cyttsp5_touch tch[MAX_FINGER_NUM];
}; 
//spyder end
...
//#define GTP_ESD_PROTECT      0 //spyder 1       // esd protection with a cycle of 2 seconds
...
 \
}
...
#if GTP_CUSTOM_CFG
#define GTP_MAX_HEIGHT   400
#define GTP_MAX_WIDTH    400
...
#define GTP_ADDR_LENGTH             1      //spyder  address length??
#define GTP_CONFIG_MIN_LENGTH       186
#define GTP_CONFIG_MAX_LENGTH       240
#define FAIL                        0
#define SUCCESS                     1
#define SWITCH_OFF                  0
#define SWITCH_ON                   1
#define POWER_ON	SWITCH_ON
#define POWER_OFF	SWITCH_OFF
...
//Register define
#define GTP_READ_COOR_ADDR          0x814E  //spyder  address???
