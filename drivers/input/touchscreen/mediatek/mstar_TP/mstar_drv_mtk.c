...
#if 1 //def CONFIG_PLATFORM_USE_ANDROID_SDK_6_UPWARD
#ifdef CONFIG_ENABLE_REGULATOR_POWER_ON
...
#if 1 //def CONFIG_PLATFORM_USE_ANDROID_SDK_6_UPWARD
#ifdef CONFIG_ENABLE_REGULATOR_POWER_ON
    const char *vdd_name = "VGP2";
//    const char *vcc_i2c_name = "vcc_i2c";
#endif //CONFIG_ENABLE_REGULATOR_POWER_ON
#endif //CONFIG_PLATFORM_USE_ANDROID_SDK_6_UPWARD

    printk(" msg TPD probe\n");   
    ...
    if (ret)
    {
        printk("MSG Could not set to 2800mv.\n");
    }else
    {
    	printk("MSG regulator_set_voltage OK\n");
    }
#endif //CONFIG_ENABLE_REGULATOR_POWER_ON
#endif //CONFIG_PLATFORM_USE_ANDROID_SDK_6_UPWARD
...
static const struct i2c_device_id tpd_device_id[] ={{MSG_TP_IC_NAME, 0},{}, };
...
static int  tpd_driver_init(void) 
{
...
static void  tpd_driver_exit(void) 
{
