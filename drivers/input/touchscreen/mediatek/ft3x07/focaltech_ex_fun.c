...
int fts_create_sysfs(struct i2c_client *client)
{
	...
	I2CDMABuf_va = (u8 *)dma_alloc_coherent(&tpd->dev->dev/*NULL*/, FTS_DMA_BUF_SIZE, &I2CDMABuf_pa, GFP_KERNEL);
...
void fts_release_sysfs(struct i2c_client *client)
{
	...
	if(I2CDMABuf_va)
	{
		dma_free_coherent(&tpd->dev->dev/*NULL*/, FTS_DMA_BUF_SIZE, I2CDMABuf_va, I2CDMABuf_pa);
		I2CDMABuf_va = NULL;
		I2CDMABuf_pa = 0;
	}
