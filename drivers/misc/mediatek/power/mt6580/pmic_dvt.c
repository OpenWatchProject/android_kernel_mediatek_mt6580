...
void tc_bif_reset_slave(void)
{
    ...
    //dump
    pr_info("[PMIC]Reg[0x%x]=0x%x,Reg[0x%x]=0x%x\n", 
...
void tc_bif_1003_step_5_positive(void)
{
    ...
    //dump
    pr_info("[PMIC]Reg[0x%x]=0x%x,Reg[0x%x]=0x%x,Reg[0x%x]=0x%x,Reg[0x%x]=0x%x\n", 
        MT6325_BIF_CON15,upmu_get_reg_value(MT6325_BIF_CON15),
        MT6325_BIF_CON17,upmu_get_reg_value(MT6325_BIF_CON17),
    ...
    //dump
    pr_info("[PMIC]BIF_RX_DATA_SW=0 : Reg[0x%x]=0x%x\n",         
        MT6325_BIF_CON30,upmu_get_reg_value(MT6325_BIF_CON30)
        );
...
void tc_bif_1004_step_1_positive(void)
{
    ...
    ret=pmic_config_interface(MT6325_BIF_CON30, 0x1, 0x1, 4);
    //dump
    pr_info("[PMIC]after set, Reg[0x%x]=0x%x\n", 
        MT6325_BIF_CON30,upmu_get_reg_value(MT6325_BIF_CON30)
        );
...
void tc_bif_1006_step_1(void)
{
    ...
    //dump
    pr_info("[PMIC]disable sw control : Reg[0x%x]=0x%x\n", 
        MT6325_BIF_CON30,upmu_get_reg_value(MT6325_BIF_CON30)
        );
...
void exec_6325_efuse_test(void)
{
    ...
    //dump
    pr_info("[PMIC]Reg[0x%x]=0x%x,Reg[0x%x]=0x%x,Reg[0x%x]=0x%x\n", 
    ...
    for(i=0;i<=0x1F;i++)
    {
        ...
        //6. read data
        pr_info("[PMIC]i=%d,Reg[0x%x]=0x%x,Reg[0x%x]=0x%x,Reg[0x%x]=0x%x\n", 
            i,
