...
static kal_uint32 charging_enable(void *data)
{
    ...
    battery_log(BAT_LOG_CRTI, "[%s][charger_rt9536] charger enable = %d, g_charging_current = %d \r\n", __func__, enable, g_charging_current);
...
static kal_uint32 charging_set_current(void *data)
{
    ...
    battery_log(BAT_LOG_CRTI, "[%s][charger_rt9536] current_value = %d,     g_charging_current = %d \r\n", __func__, current_value, g_charging_current);
