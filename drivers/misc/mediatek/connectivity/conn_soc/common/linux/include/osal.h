...
#define osal_err_print(fmt, arg...) osal_print(fmt, ##arg)
#define osal_warn_print(fmt, arg...) osal_print(fmt, ##arg)
#define osal_info_print(fmt, arg...) osal_print(fmt, ##arg)
#define osal_loud_print(fmt, arg...) osal_print(fmt, ##arg)
#define osal_dbg_print(fmt, arg...) osal_print(fmt, ##arg)
