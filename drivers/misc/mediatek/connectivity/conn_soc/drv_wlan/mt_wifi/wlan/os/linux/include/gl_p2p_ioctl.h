...
mtk_p2p_cfg80211_remain_on_channel(struct wiphy *wiphy,
				   ...
				   enum nl80211_channel_type channel_type, unsigned int duration, u64 *cookie);

int mtk_p2p_cfg80211_scan(struct wiphy *wiphy, struct net_device *ndev, struct cfg80211_scan_request *request);

int mtk_p2p_cfg80211_cancel_remain_on_channel(struct wiphy *wiphy, struct net_device *dev, u64 cookie);
...
#else
int mtk_p2p_cfg80211_add_set_beacon(struct wiphy *wiphy, struct net_device *dev, struct beacon_parameters *info);
...
mtk_p2p_cfg80211_mgmt_tx(struct wiphy *wiphy,
			 ...
			 bool offchan,
			 enum nl80211_channel_type channel_type,
			 bool channel_type_valid, unsigned int wait, const u8 *buf, size_t len, u64 *cookie);
...
mtk_p2p_cfg80211_set_channel(IN struct wiphy *wiphy,
			     ...
			     IN struct ieee80211_channel *chan, IN enum nl80211_channel_type channel_type);

void
mtk_p2p_cfg80211_mgmt_frame_register(IN struct wiphy *wiphy, IN struct net_device *dev, IN u16 frame_type, IN bool reg);
