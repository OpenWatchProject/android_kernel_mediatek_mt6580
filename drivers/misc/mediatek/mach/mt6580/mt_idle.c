...
bool is_dpidle = 0;
module_param(is_dpidle, bool, 0444);
...
void __attribute__((weak))
mtkts_wmt_cancel_thermal_timer(void)
{
...
void __attribute__((weak))
mtkts_wmt_start_thermal_timer(void)
{
...
static inline void dpidle_post_handler(void)
{
    ...
    // restar mali memory frame timer
    is_dpidle = 0;
}
