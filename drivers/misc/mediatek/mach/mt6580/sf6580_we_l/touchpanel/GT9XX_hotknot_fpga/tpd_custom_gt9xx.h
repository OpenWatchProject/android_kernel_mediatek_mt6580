...
#define CTP_CFG_GROUP1 {\
    ...
    0x1D,0x00,0x7D,0x25,0x00,0x65,0x30,0x00,\
    0x54,0x3E,0x00,0x54,0x00,0x00,0x00,0x00,\
    ...
    0xCC,0xCC,0xCC,0xCC,0xCC,0xCC,0x28,0xA8,\
    0x02,0x08,0x7C,0x06,0x30,0x2D,0xD2,0xFA,\
...
#if 1 //FPGA
#define GPIO_CTP_RST_PIN 105
#define GPIO_CTP_EINT_PIN 103
...
#define GTP_EINT_NUMBER CUST_EINT_TOUCH_PANEL_NUM
...
#define mt_set_gpio_out do{}while(0);
#define mt_set_gpio_dir do{}while(0);
#define mt_set_gpio_pull_enable do{}while(0);
#define mt_set_gpio_mode do{}while(0);
#define mt_set_gpio_out do{}while(0);
