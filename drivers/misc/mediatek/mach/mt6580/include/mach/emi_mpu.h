...
{
    /* apmcu write */
    MST_ID_APMCU_W0,  MST_ID_APMCU_W1,  MST_ID_APMCU_W2,  MST_ID_APMCU_W3,  MST_ID_APMCU_W4,

    /* apmcu read */
    MST_ID_APMCU_R0,  MST_ID_APMCU_R1,  MST_ID_APMCU_R2,  MST_ID_APMCU_R3,  MST_ID_APMCU_R4,
    MST_ID_APMCU_R5,  MST_ID_APMCU_R6,  MST_ID_APMCU_R7,  MST_ID_APMCU_R8,  MST_ID_APMCU_R9,
    MST_ID_APMCU_R10, MST_ID_APMCU_R11, MST_ID_APMCU_R12, MST_ID_APMCU_R13,

    /* MM */
    MST_ID_MM_0, MST_ID_MM_1, MST_ID_MM_2, MST_ID_MM_3, MST_ID_MM_4,
    MST_ID_MM_5, MST_ID_MM_6,
