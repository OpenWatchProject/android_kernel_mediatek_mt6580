...
#define SPM_MFG_2D_PWR_CON      (SPM_BASE + 0x2c0) //not in CODA
...
#define SPM_PCM_WDT_LATCH     (SPM_BASE+0xb24) //new feature
...
#define SPM_SLEEP_CA15_WFI0_EN		(SPM_BASE + 0xf10)//not support, not in CODA
#define SPM_SLEEP_CA15_WFI1_EN		(SPM_BASE + 0xf14)//not support, not in CODA
#define SPM_SLEEP_CA15_WFI2_EN		(SPM_BASE + 0xf18)//not support, not in CODA
#define SPM_SLEEP_CA15_WFI3_EN		(SPM_BASE + 0xf1c)//not support, not in CODA
...
#define SPM_CPU_DVS_DIS		(1U << 9)//no use
#define SPM_CPU_DORMANT		(1U << 10)//no use
#define SPM_EXT_VSEL_GPIO103    (1U << 11)//no use
#define SPM_DDR_HIGH_SPEED		(1U << 12)//no use

//FIXME: not list in PCM_FLAGS excel yet
...
//extern int spm_set_vcore_dvs_voltage(int index);
//extern int spm_get_vcore_dvs_voltage(void);
