...
#ifdef VDEC_BREAK_EN
#define VDEC_BREAK_FRAME_INDEX 5 // Set 0 to break all frames, 1st frame's index = 1
#endif
//#define VDEC_VP8_NO_COMPARE
#ifdef VDEC_VP8_NO_COMPARE
#define VDEC_STOP_FRAME_INDEX 1000 // 1st frame's index = 1
#endif
//#define REDEC
//#define EXT_COMPARE
