...
extern bool msdc_hwPowerOn(MSDC_POWER_DOMAIN powerId, u32 powerVolt, char *mode_name);
extern bool msdc_hwPowerDown(MSDC_POWER_DOMAIN powerId, char *mode_name);
static unsigned int simp_msdc_ldo_power(unsigned int on, MSDC_POWER_DOMAIN powerId, u32 powerVolt)
{
...
static unsigned int simp_mmc_power_up(struct simp_mmc_host *host,bool on)
{
    ...
    switch(host->mtk_host->id){
        case 0:
            simp_msdc_ldo_power(on, MSDC_VEMC33, 3000000);
            break;
        case 1:
            simp_msdc_ldo_power(on, MSDC_VMC, 3000000);
            simp_msdc_ldo_power(on, MSDC_VMCH, 3000000);
            break;
        default:
            break;
    }
...
static unsigned int simp_msdc_init(struct simp_mmc_host *mmc_host)
{
    ...
    switch(host->id){
        ...
        case 0:
            ...
            sdr_set_field(MSDC0_DRVING0_BASE, MSDC0_DAT7_DRVING, msdc0_hw.dat_drv);
            sdr_set_field(MSDC0_DRVING0_BASE, MSDC0_DAT6_DRVING, msdc0_hw.dat_drv);
            sdr_set_field(MSDC0_DRVING0_BASE, MSDC0_DAT5_DRVING, msdc0_hw.dat_drv);
            sdr_set_field(MSDC0_DRVING0_BASE, MSDC0_DAT4_DRVING, msdc0_hw.dat_drv);

            sdr_set_field(MSDC0_DRVING1_BASE, MSDC0_DAT3_DRVING, msdc0_hw.dat_drv);
            sdr_set_field(MSDC0_DRVING1_BASE, MSDC0_DAT2_DRVING, msdc0_hw.dat_drv);
            sdr_set_field(MSDC0_DRVING1_BASE, MSDC0_DAT1_DRVING, msdc0_hw.dat_drv);
            sdr_set_field(MSDC0_DRVING1_BASE, MSDC0_DAT0_DRVING, msdc0_hw.dat_drv);
            sdr_set_field(MSDC0_DRVING1_BASE, MSDC0_CLK_DRVING, msdc0_hw.clk_drv);
            sdr_set_field(MSDC0_DRVING1_BASE, MSDC0_RST_DRVING, msdc0_hw.rst_drv);
            sdr_set_field(MSDC0_DRVING1_BASE, MSDC0_CMD_DRVING, msdc0_hw.cmd_drv);
            break;
      #endif
      #if defined(CFG_DEV_MSDC1)
        case 1:
            ...
            sdr_set_field(MSDC1_DRVING_BASE, MSDC1_DAT3_DRVING, msdc1_hw.dat_drv);
            sdr_set_field(MSDC1_DRVING_BASE, MSDC1_DAT2_DRVING, msdc1_hw.dat_drv);
            sdr_set_field(MSDC1_DRVING_BASE, MSDC1_DAT1_DRVING, msdc1_hw.dat_drv);
            sdr_set_field(MSDC1_DRVING_BASE, MSDC1_DAT0_DRVING, msdc1_hw.dat_drv);
            break;
      #endif
...
static int simp_mmc_init(int card_type,bool boot)
{
    ...
    if(boot){
            ...
            if(pmmc_boot_host->mtk_host->id >= HOST_MAX_NUM)
                return -1;
        #ifdef CONFIG_OF
            if (!mtk_msdc_host[pmmc_boot_host->mtk_host->id])
                return -1;
            ...
            if(pmmc_extend_host->mtk_host->id >= HOST_MAX_NUM)
                return -1;
        #ifdef CONFIG_OF
            if (!mtk_msdc_host[pmmc_extend_host->mtk_host->id])
                return -1;
            pmmc_extend_host->mtk_host->base = (mtk_msdc_host[pmmc_extend_host->mtk_host->id])->base;
