...
#define  ENABLE_EMI_PROTECTION              //disable for bring up // ToDo: to check SET_ACCESS_PERMISSON parameter
// #define EMI_MPU_SET_AP_REGION    // set EMI MPU AP REGION
...
#define CCIF_STD_V1_RUN_TIME_DATA_OFFSET    (0x240)        //need confirm
